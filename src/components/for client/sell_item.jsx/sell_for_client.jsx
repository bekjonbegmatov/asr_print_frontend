...
function Sell_For_Client(props) {
    ...
    function get_ifo_about_user() {
        fetch(`${props.IP_ADRESS}client/${props.client}`)
            .then(response => response.json())
            .then(data => {
                // console.log(data);
    ...
    function saled() {
        if (quantity != 0 && quantity > 0) {
            fetch(`${props.IP_ADRESS}client/action/create`, {
                method: "POST",
                headers: {
...
export default Sell_For_Client;